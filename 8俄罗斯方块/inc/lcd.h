...
/*
画矩形函数
输入x0，y0为矩形左上角坐标点，w为宽，h为高 color为颜色
*/
void draw_juxing(int x0,int y0,int w,int h,unsigned int color);
...
*/
void Lcd_Number(int x0, int y0, int color, int data, int len, int gap);
